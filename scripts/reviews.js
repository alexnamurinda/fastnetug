...
document.addEventListener('DOMContentLoaded', function() {
    ...
    activeFilterTags.addEventListener('click', function(e) {
        if (e.target.classList.contains('fa-times')) {
            ...
            if (tagText === 'All Locations' || tagText.includes('Hostel') || tagText.includes('Lower Herman') || tagText.includes('New Hostel')) {
                serviceFilter.value = 'all';
    ...
    function updateActiveFilterTags() {
        ...
        let serviceTagText = 'All Locations';
        if (currentFilters.service === 'namuli') serviceTagText = 'Namuli Hostel';
        if (currentFilters.service === 'kasalita') serviceTagText = 'Kasalita Hostel';
        if (currentFilters.service === 'herman') serviceTagText = 'Herman Hostel';
        if (currentFilters.service === 'new-hostel') serviceTagText = 'New Hostel';
        if (currentFilters.service === 'lower-herman') serviceTagText = 'Lower Herman';
