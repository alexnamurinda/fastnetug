    ...
    fetch(`${API_URL}?action=getClient&id=${id}`)
        ...
        .then(data => {
            if(data.success) {
                ...
                document.getElementById('editClientName').value = data.client.customer_name;
                document.getElementById('editClientPhone').value = data.client.phone_number || '';
